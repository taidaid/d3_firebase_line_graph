...
const yDottedLine = dottedLines
  ...
  .attr("stroke-dasharray", 4);
const update = data => {
  // filter data based on the currently selected button
  ...
  console.log(data);
  // set scale domains
  // d3.extent returns min and max values as an array. passing in d.date to Date() to return the
  // .toString() of the date to an actual date object for comparison
